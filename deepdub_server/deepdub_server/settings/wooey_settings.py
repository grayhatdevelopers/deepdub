...
if DJANGO_VERSION < DJ110:
    ...
    MIDDLEWARE_CLASSES.append('deepdub_server.middleware.ProcessExceptionMiddleware')
    MIDDLEWARE_OBJ = MIDDLEWARE_CLASSES
else:
    # Using Django 1.10 +
    MIDDLEWARE = list(MIDDLEWARE)
    MIDDLEWARE.append('deepdub_server.middleware.ProcessExceptionMiddleware')
...
NEW_MIDDLEWARE.append('deepdub_server.middleware.ProcessExceptionMiddleware')
if DJANGO_VERSION < DJ110:
    MIDDLEWARE_CLASSES = NEW_MIDDLEWARE
else:
    MIDDLEWARE = NEW_MIDDLEWARE

PROJECT_NAME = "deepdub_server"
